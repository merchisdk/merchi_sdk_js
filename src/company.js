...
export function Company() {
    ...
    addPropertyTo(this, 'australiaPostApiKey');
    addPropertyTo(this, 'australiaPostPassword');
    addPropertyTo(this, 'startrackApiKey');
    addPropertyTo(this, 'startrackPassword');
    addPropertyTo(this, 'dhlApiKey');
    addPropertyTo(this, 'dhlApiSecret');
    addPropertyTo(this, 'fedexApiKey');
    addPropertyTo(this, 'fedexApiSecret');
    addPropertyTo(this, 'upsClientId');
    addPropertyTo(this, 'upsClientSecret');
    addPropertyTo(this, 'uspsApiKey');
    addPropertyTo(this, 'tntApiKey');
    addPropertyTo(this, 'tntApiSecret');
    addPropertyTo(this, 'aramexAccountNumber');
    addPropertyTo(this, 'aramexApiKey');
    addPropertyTo(this, 'aramexApiSecret');
    addPropertyTo(this, 'nzPostApiKey');
